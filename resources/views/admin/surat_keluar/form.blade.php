                     ...
                     <div class="row">
                         ...
                         <div class="col-12 col-md-9">
                             <div class="mb-3">
                                 ...
                                 <input class="form-control inputReset" type="text" id="tujuan_surat"
                                     name="tujuan_surat">
                             </div>
                         </div>
                         <div class="col-12 col-md-3">
                             <div class="mb-3">
                                 <label for="tgl_keluar" class="form-label">Tgl. Keluar</label>
                                 <input class="form-control inputReset" type="date" id="tgl_keluar" name="tgl_keluar">
                             </div>
                         </div>
                         <div class="col-12">
                             <div class="mb-3">
