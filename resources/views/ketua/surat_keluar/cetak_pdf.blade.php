...
<body>
    <div>
        <img class="logo" width="80px" src="{{ public_path('/assets/images/auth-bg.jpg') }}" alt=""
            srcset="">
        <div>
            <p class="text-center m-0 text-uppercase" style="font-size: 18px"> Badan Kesatuan Bangsa dan Politik</p>
            <p class="text-center m-0 text-uppercase" style="font-size: 18px">Kota Bogor</p>
